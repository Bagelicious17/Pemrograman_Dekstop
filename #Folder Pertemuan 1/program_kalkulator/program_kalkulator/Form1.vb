Public Class program_kalkulator
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Cmd7.Click
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Cmd9.Click
        If inputStatus = False Then
    ...
    Private Sub txtInput_Load(sender As Object, e As EventArgs) Handles MyBase.Load
